<div class='panel-body'>
    ...
    <div id='myTabContent' class='tab-content'>
                ...
                <div id="writecomment">
                    <form action="<?php echo base_url(); ?>auth/register" method="POST" id="form_komentar">
                        ...
                        <p class="contact-form-message">
                            ...
                            <?php echo "<select style='margin-left:5px'  name='g' id='state' required>
                        ...
                        <p class="contact-form-message">
                            ...
                            <select style='margin-left:5px' name='h' id='city' required>
                                <option value=''>- Pilih -</option>
                            </select>
                        </p>
        ...
        <div role='tabpanel' class='tab-pane fade' id='reseller' aria-labelledby='reseller-tab'>
            <div class='alert alert-warning'><b>PENTING!</b> Lengkapi Form dibawah ini untuk mendaftarkan diri sebagai <b>Reseller</b>, harap di isi dengan data yang sebenar-benarnya, Terima kasih...</div>
            <div class="block-content">
                <div id="writecomment">
                    <form action="<?php echo base_url(); ?>auth/register" method="POST" id="form_komentar">
                        <p class="contact-form-user">
                        ...
                        <p class="contact-form-message">
                            <label for="c_message">Provinsi<span class="required">*</span></label>
                            <?php echo "<select style='margin-left:5px'  name='state' id='state_reseller' required>
                                            <option value=''>- Pilih -</option>";
                            foreach ($provinsi as $rows) {
                                echo "<option value='$rows[provinsi_id]'>$rows[nama_provinsi]</option>";
                            }
                        ...
                        <p class="contact-form-message">
                            <label for="c_message">Kota<span class="required">*</span></label>
                            <select style='margin-left:5px' name='kota' id='city_reseller' required>
                                <option value=''>- Pilih -</option>
                            </select>
                        </p>
