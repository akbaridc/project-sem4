<p class='sidebar-title text-danger produk-title'>Detail Data Reseller</p>
      ...
      <div class='col-md-12'>
        <table class='table table-condensed'>
          <tbody>
            ...
            ?>
            <tr bgcolor='#e3e3e3'>
              <td rowspan='12' width='110px'><?php echo "<img style='border:1px solid #cecece; height:85px; width:85px' src='" . base_url() . "asset/foto_user/$foto_user' class='img-circle img-thumbnail'>"; ?></td>
            </tr>
            <tr>
              <th scope='row' width='140px'>Nama Reseller</th>
