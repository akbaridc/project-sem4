...
echo "</select></td></tr>
                    ...
                    <tr><th scope='row'>Harga</th>             <td><input type='number' class='form-control' name='f' value='$rows[harga]'></td></tr>
...
if ($rows['gambar'] != '') {
  echo "<i style='color:red'>Gambar Saat ini : </i><a target='_BLANK' href='" . base_url() . "asset/foto_produk/$rows[gambar]'>$rows[gambar]</a>";
}
echo "</td></tr>
                  </tbody>
                  </table>
